      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title={editing ? t('edit_customer') : t('new_customer')}>
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div><label className="label">{t('phone_primary')}</label><input className="input" value={form.phone_primary} onChange={(e) => setForm({ ...form, phone_primary: e.target.value })} /></div>
