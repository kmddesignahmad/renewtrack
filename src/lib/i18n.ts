...
export const translations = {
  en: {
    ...
    reports_password_prompt: 'Enter admin password to access reports',
    reports_verify: 'Verify & Access',
    reports_verifying: 'Verifying...',
    ...
    recent_renewals_report: 'Recent Renewals',
  ...
  ar: {
    ...
    reports_password_prompt: 'أدخل كلمة مرور الأدمن للوصول للتقارير',
    reports_verify: 'تحقق والدخول',
    reports_verifying: 'جاري التحقق...',
    reports_summary: 'الملخص',
    total_subscriptions: 'إجمالي الاشتراكات',
    total_revenue: 'إجمالي الإيرادات',
    active_revenue: 'إيرادات الاشتراكات النشطة',
    monthly_breakdown: 'تفصيل شهري',
    yearly_breakdown: 'تفصيل سنوي',
    top_customers: 'أفضل العملاء',
    service_breakdown: 'تفصيل الخدمات',
    recent_renewals_report: 'آخر التجديدات',
    sub_count: 'الاشتراكات',
    revenue: 'الإيرادات',
    month_col: 'الشهر',
    year_col: 'السنة',
    count: 'العدد',
